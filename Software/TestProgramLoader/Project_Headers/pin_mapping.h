 ...
 * @version   1.2.0
 * @brief     Pin declarations for MK20DX128VLH5
 *
 * *****************************
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   0: XTAL0                = PTA19 (p33)                    */  { PortAInfo,  GPIOA_BasePtr,  19,      PORT_PCR_MUX(0)|defaultPcrValue  },
         /*   1: EXTAL0               = PTA18 (p32)                    */  { PortAInfo,  GPIOA_BasePtr,  18,      PORT_PCR_MUX(0)|defaultPcrValue  },
   };
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   3: ADC0_SE3             = ADC0_DP3 (p11)                 */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
         ...
         /*  15: ADC0_SE15            = PTC1 (p44)                     */  { PortCInfo,  GPIOC_BasePtr,  1,       PORT_PCR_MUX(0)|defaultPcrValue  },
         ...
         /*  21: ADC0_SE21            = ADC0_DM3 (p12)                 */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
         /*  22: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
         /*  23: ADC0_SE23            = ADC0_SE23 (p18)                */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
   };
...
#define USBDM_ADC0_INFODP_IS_DEFINED
   ...
   public:
      ...
      static constexpr PinInfo  info[] = {
            ...
            /*   1: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
            /*   2: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
            /*   3: ADC0_DP3             = ADC0_DP3 (p11)                 */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
      };
...
#define USBDM_ADC0_INFODM_IS_DEFINED
   ...
   public:
      ...
      static constexpr PinInfo  info[] = {
            ...
            /*   1: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
            /*   2: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
            /*   3: ADC0_DM3             = ADC0_DM3 (p12)                 */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
      };
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   2: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
         /*   3: CMP1_IN3             = ADC0_SE23 (p18)                */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
         /*   4: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   2: VDD2                 = VDD2 (p30)                     */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
         /*   3: VDD3                 = VDD3 (p48)                     */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
         /*   4: VDDA                 = VDDA (p13)                     */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
         /*   5: VOUT33               = VOUT33 (p7)                    */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
         /*   6: VREFH                = VREFH (p14)                    */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
         /*   7: VREFL                = VREFL (p15)                    */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
         /*   8: VREGIN               = VREGIN (p8)                    */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
         /*   9: VSS1                 = VSS1 (p4)                      */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
         /*  10: VSS2                 = VSS2 (p31)                     */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
         /*  11: VSS3                 = VSS3 (p47)                     */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
         /*  12: VSSA                 = VSSA (p16)                     */  { NoPortInfo, 0,         FIXED_NO_PCR, 0 },
   };
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*  14: TSI0_CH14            = PTC1 (p44)                     */  { PortCInfo,  GPIOC_BasePtr,  1,       PORT_PCR_MUX(0)|defaultPcrValue  },
 ...
 * @{
 */
using Adc_p10              = const USBDM::Adc0::Channel<19>;
using Adc_p12              = const USBDM::Adc0::Channel<21>;
using Adc_p9               = const USBDM::Adc0::Channel<0>;
using Adc_p11              = const USBDM::Adc0::Channel<3>;
using Adc_p18              = const USBDM::Adc0::Channel<23>;
using Adc_p44              = const USBDM::Adc0::Channel<15>;
/** 
 * End group ADC_Group
 * @}
 */
...
using Gpio_p36             = const USBDM::GpioB<1>;
using Gpio_p37             = const USBDM::GpioB<2>;
