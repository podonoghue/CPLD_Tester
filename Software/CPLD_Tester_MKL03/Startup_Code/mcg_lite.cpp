...
const ClockInfo Mcg::clockInfo[] = {
   {  // ClockConfig_RUN_HIRC_48MHz (McgClockMode_HIRC_48MHz)
      ...
      SIM_CLKDIV1_OUTDIV4(1) | // Flash Clock Divider (OUTDIV4) - Divide by [1-16] - /2
      SIM_CLKDIV1_OUTDIV1(0),  // Core & System Clock Divider (OUTDIV1) - Divide by [1-16] - /1

      Sim::DefaultSopt2Values[ClockConfig_RUN_HIRC_48MHz].sopt2,

      /// Clock Mode 
      McgClockMode_HIRC_48MHz,  // MCG Clock Mode - 48 MHz IRC (HIRC_48MHz)
