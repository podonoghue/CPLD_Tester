...
Startup_Code/%.o: ../Startup_Code/%.c
	@echo 'Building file: $<'
	@echo 'Invoking: ARM C Compiler'
	arm-none-eabi-gcc -mcpu=cortex-m0plus -mthumb -g3 -O0 -ffunction-sections -fdata-sections -Wall -Wextra -DDEBUG_BUILD -DCPU_MKL03Z8VFG4 -I"C:/Users/podonoghue/Documents/Development/CPLD_Tester/Software/CPLD_Tester_MKL03/Sources" -I"C:/Users/podonoghue/Documents/Development/CPLD_Tester/Software/CPLD_Tester_MKL03/Project_Headers" -std=c11 -c -fmessage-length=0 -MT"$@" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)"  -o "$@" $<
	@echo 'Finished building: $<'
	@echo ' '
...
Startup_Code/%.o: ../Startup_Code/%.S
	...
	arm-none-eabi-gcc -mcpu=cortex-m0plus -mthumb -g3 -O0 -ffunction-sections -fdata-sections -Wall -Wextra -x assembler-with-cpp -DDEBUG_BUILD -I"C:/Users/podonoghue/Documents/Development/CPLD_Tester/Software/CPLD_Tester_MKL03/Project_Headers" -Wall -Wextra -c -fmessage-length=0  -o "$@" $<
	@echo 'Finished building: $<'
	@echo ' '
