...
Startup_Code/%.o: ../Startup_Code/%.S
	...
	arm-none-eabi-gcc -mcpu=cortex-m0plus -mthumb -g3 -O0 -ffunction-sections -fdata-sections -Wall -Wextra -x assembler-with-cpp -DDEBUG_BUILD -I"C:/Users/podonoghue/Documents/Development/CPLDTester/Software/CPLD_Tester_MKL03/Project_Headers" -Wall -Wextra -c -fmessage-length=0  -o "$@" $<
	@echo 'Finished building: $<'
	@echo ' '
