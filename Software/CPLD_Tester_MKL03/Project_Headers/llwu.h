...
// /LLWU/llwu_base_methods not found
   ...
   static constexpr LlwuInfo::Init DefaultInitValue {
      ...
      LlwuPin_3, LlwuPinMode_Disabled,  // Unused input 3 - Wake-up pin disabled, 
      LlwuPin_4, LlwuPinMode_Disabled,  // Pin PTB0 - Wake-up pin disabled, 
      LlwuPin_5, LlwuPinMode_Disabled,  // Unused input 5 - Wake-up pin disabled, 
      LlwuPin_6, LlwuPinMode_Disabled,  // Unused input 6 - Wake-up pin disabled, 
      LlwuPin_7, LlwuPinMode_Disabled,  // Pin PTA0 - Wake-up pin disabled, 
      LlwuFilterNum_1, LlwuPin_4 , // Filter 1 Pin Select - Pin PTB0
